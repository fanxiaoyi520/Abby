...
NSString * aesEncrypt(NSString *content){
    return aesEncryptString(content, AES_KEY);
}
...
NSDictionary * aesDecryptWithData(NSData *content){
    ...
    NSData *data = aesDecryptData(contentData,[AES_KEY dataUsingEncoding:NSUTF8StringEncoding]);
