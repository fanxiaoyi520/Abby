...
+(void)encodeHeader{
    ...
    if (ValidStr([UserManager sharedUserManager].curUserInfo.token)) {
        [_sessionManager.requestSerializer setValue:[UserManager sharedUserManager].curUserInfo.token forHTTPHeaderField:@"token"];
    }
