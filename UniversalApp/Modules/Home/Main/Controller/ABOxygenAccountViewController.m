//
//  ABOxygenAccountViewController.m
//  UniversalApp
//
...
@interface ABOxygenAccountViewController ()
@property (nonatomic , strong)UIImageView *tabImgView;
@property (nonatomic , strong)UILabel *titleLab;
@property (nonatomic , strong)UIView *lineView;
@end

@implementation ABOxygenAccountViewController
...
- (void)superConfigure {
    self.bg_Height = 363;
    self.isLeft = NO;
    self.content_Str = @"Oxygen is points, you can use oxygen to buy abby’s goods and services.\n\nThe oxygen generated will disappear if it is not collected for 24 hours.";
}
...
- (void)setupUI {
    ...
    self.tabImgView.image = ImageName(@"icon_h_Status");
    
    self.titleLab.text = @"Oxygen  account";
