...
@interface ABMyJournalViewController ()<ABTrendDelegate,UITableViewDelegate,UITableViewDataSource,ABPopBgDelege,ABMyJournalCellFuncDelegate>
...
@implementation ABMyJournalViewController
...
- (void)setupUI {
    ...
    [self.tableView registerClass:[ABMyJournalCell class] forCellReuseIdentifier:NSStringFromClass([ABMyJournalCell class])];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ABMyJournalCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([ABMyJournalCell class]) forIndexPath:indexPath];
    cell.delegate = self;
...
- (void)myJournal_moreAction:(UIButton *)sender {
    ...
    ABPopBgView *bgView = [ABPopBgView loadPopBgViewWith:ABDeleteAndSync];
    bgView.bounds = CGRectMake(0, 0, 171, 100);
...
- (void)myJournal_updeteCellHeight:(UIButton *)sender {
    ABMyJournalCell *cell = (ABMyJournalCell *)sender.superview;
