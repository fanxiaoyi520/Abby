...
typedef NS_ENUM(NSInteger, LoginStatus){
    kUserLoginStatusNotLoggedIn = 0,//未登陆
    kUserLoginStatusLoggedIn,//正常登陆
    kUserLoginStatusLoggedInUnboundDevice,///未绑定设备
};

typedef NS_ENUM(NSInteger, TabbarStatus){
    kTabbarStatusDefault = 0,//正常状态
    kTabbarStatusNoWaterNoPlant,//无水无植株
};
