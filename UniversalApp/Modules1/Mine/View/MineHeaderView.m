...
//    
//    self.signatureLabel.text = userInfo.sid;
//    if (!userInfo.sid) {
...
////未登录状态展示
//    if (userInfo) {
//        self.showIDLabel.text = NSStringFormat(@"ID: %@",userInfo.info);
//        [self.nickNameView setNickName:userInfo.nickname sex:userInfo.sex age:26 level:userInfo.sex];
////        [self.headImgView setImageWithURL:[NSURL URLWithString:userInfo.photo] placeholder:[UIImage imageWithColor:KGrayColor]];
//        [self.headImgView sd_setImageWithURL:[NSURL URLWithString:userInfo.headPic] placeholderImage:[UIImage imageWithColor:KGrayColor]];
//    }else{
