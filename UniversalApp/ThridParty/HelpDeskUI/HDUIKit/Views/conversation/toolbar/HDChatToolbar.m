...
- (void)_setupSubviews
{
    ...
    _backgroundImageView.backgroundColor = KWhiteColor;
//    _backgroundImageView.image = [[UIImage imageNamed:@"HelpDeskUIResource.bundle/messageToolbarBg"] stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];
    ...
    //input textview
    _inputTextView = [[HDTextView alloc] initWithFrame:CGRectMake(self.horizontalPadding, self.verticalPadding*2, self.frame.size.width - self.verticalPadding * 2, 40)];
    ...
    _inputTextView.backgroundColor = [UIColor colorWithHexString:@"0xF7F7F7"];
    ViewRadius(_inputTextView, 4);
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/hd_chatting_setmode_pic_btn_normal"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/hd_chatting_setmode_pic_btn_normal"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/hd_chatting_setmode_O2_btn_normal"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/hd_chatting_setmode_O2_btn_normal"] forState:UIControlStateSelected];
...
- (void)photoAction
{
    if (_delegate && [_delegate respondsToSelector:@selector(add_moreViewTakePicAction:)]) {
        [_delegate add_moreViewTakePicAction:(HDChatBarMoreView *)self.moreView];
    }
}

- (void)faceButtonAction:(id)sender
{
    [self oxygenReward:sender];
    /**
    UIButton *button = (UIButton *)sender;
    button.selected = !button.selected;
...
- (void)oxygenReward:(id)sender {
    if (_delegate && [_delegate respondsToSelector:@selector(add_oxygenRewardAction:)]) {
        [_delegate add_oxygenRewardAction:sender];
    }
}
